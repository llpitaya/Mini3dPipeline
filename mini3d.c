...
void transform_apply(const transform_t *ts, vector_t *y, const vector_t *x) {
	matrix_apply(y, x, &ts->transform); //y = x * m
}
...
typedef struct { float top, bottom; edge_t left, right; } trapezoid_t;//渲染主体*
typedef struct { vertex_t v, step; int x, y, w; } scanline_t;//扫面线的定义*
